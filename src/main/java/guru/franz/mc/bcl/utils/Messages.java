...
public class Messages {
    ...
    public static String EDIT_CHUNKLOADER_LOG_OTHER = "%s edited %s's chunk loader at %s's radius from %s to %s,";
    public static String EDIT_CHUNKLOADER_LOG_SELF = "%s edited their chunk loader at %s's radius from %s to %s.";
    public static String EDIT_CHUNKLOADER_USER = "The chunk loader is now updated to cover %s chunks.";
    public static String DELETE_CHUNKLOADER_LOG_OTHER = "%s deleted %s's chunk loader at %s.";
    public static String DELETE_CHUNKLOADER_LOG_SELF = "%s deleted their chunk loader at %s.";
