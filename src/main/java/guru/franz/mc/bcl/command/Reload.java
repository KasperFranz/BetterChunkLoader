...
public class Reload implements CommandExecutor {
    ...
    @Override public CommandResult execute(CommandSource src, CommandContext args) {
        ...
        try {
            ...
            message.append(Text.builder("An exception happened while trying to reload the plugin, please see the console for more information.")
                    .color(Messenger.ERROR_COLOR).build());
            src.sendMessage(message.build());
